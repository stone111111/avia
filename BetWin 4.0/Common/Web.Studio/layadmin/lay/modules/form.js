...
layui.define('layer', function (exports) {
    ...
    var submit = function () {
        var button = $(this), verify = form.config.verify, stop = null
            ...
            , fieldElem = elem.find('input,select,textarea,button') //获取所有表单域   老司机309 扩展支持button组件
        ...
        layui.each(fieldElem, function (_, item) {
            ...
            // 老司机309 修正checkbox没有选中时候为空的问题
            if (/^checkbox/.test(item.type) && !item.checked) {
                field[item.name] = ""; return;
            }
    ...
    $dom.on('submit', ELEM, submit)
        ...
        .on('dblclick', '*[lay-dblsubmit]', submit);    //老司机309 设定双击事件
