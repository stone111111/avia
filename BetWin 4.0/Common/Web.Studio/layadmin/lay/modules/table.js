        ...
        if (options.url) { //Ajax请求
            ...
            $.ajax({
                ...
                , success: function (res) {
                    // 老司机309 自定义的格式转换
                    //var res = response.covert ? response.covert(result) : result;
            ...
            // 老司机309 已知数据的统计功能
            res[options.response.totalName] = options[options.response.totalName];
        ...
        var that = this
            ...
            , render = function () { //后续性能提升的重点
                ...
                layui.each(data, function (i1, item1) {
                    ...
                    that.eachCols(function (i3, item3) {
                        if (item3.align) item3.align = options.align;   // 设定默认对齐方式  老司机309
