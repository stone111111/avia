...
!function () {
    ...
    MooTools.mobile = Browser.platform == "ios" || Browser.platform == "android";
}();
...
!function () {
    ...
    String.prototype.toDate = function () {
        ...
        var date = new Date(regex.exec(value)[1].toInt(), regex.exec(value)[2].toInt(), regex.exec(value)[3].toInt(), 0, 0, 0, 0);
        return date;
    };
    ...
    String.prototype.toQRCode = function (width, height, isEncode) {
        ...
        return "//qrcode.a8.to/chart?cht=qr&chs=" + width + "x" + width + "&chl=" + str;
    };
}();
...
!function (ns) {
    ...
    ns.SoundText = function (text) {
        //ai.baidu.com/aidemo?type=tns2&idx=1&tex=%25E9%2587%258D%25E5%25BA%2586%25E6%2597%25B6%25E6%2597%25B6%25E5%25BD%25A9%2520%252020180424-088%2520%25E6%259C%259F%25E5%25BC%2580%25E5%25A5%2596%25E7%25BB%2593%25E6%259E%259C%2520&cuid=baidu_speech_demo&cod=2&lan=zh&ctp=1&pdt=1&spd=5&per=3&vol=5&pit=5
        //http://tts.baidu.com/text2audio?lan=zh&ie=UTF-8&spd=5&cod=2&text=%E8%85%BE%E8%AE%AF%E5%88%86%E5%88%86%E5%BD%A9%E7%AC%AC0714%E6%9C%9F%E5%B7%B2%E5%BC%80%E5%A5%96%EF%BC%8C%E5%BC%80%E5%A5%96%E5%8F%B7%E7%A0%81%EF%BC%9A1,5,6,8,8
        //http://fanyi.baidu.com/gettts?lan=zh&text=%E5%BC%80%E5%A5%96%E5%8F%B7%E7%A0%81&spd=5&source=web
        var url = "//fanyi.baidu.com/gettts?lan=zh&spd=5&source=web&text=" + text;
        UI.Sound(url);
    };
